                    ...
                    <div class="container form_content p-5 rounded-5 my-2 ">
                        <form action="{{ $route }}" method="post" class="text row row-cols-1 justify-content-center">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('ingredients', $dish->ingredients) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" value="{{ old('price', $dish->price) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ old('image', $dish->image) }}"
