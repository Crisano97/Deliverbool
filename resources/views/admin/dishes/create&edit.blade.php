            ...
            <div class="row">
                <div class="w-75 mx-auto">
                    ...
                    <div class="container form_content p-5 rounded-5 my-2 ">
                        <form action="{{ $route }}" method="post" class="text row row-cols-1 justify-content-center" enctype="multipart/form-data">
                            @csrf
                            @method($method)

                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Nome Piatto *</label>
                                <input type="text" value="{{ old('name', $dish->name) }}" class="form-control text_form" required
                                    id="exampleFormControlInput1" placeholder="Nome Piatto" name="name"
                                >
                            ...
                            <div class="mb-3">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <input type="radio" value="0" name="visible" id="radio-input-false"
                                        class="mr-2" {{ old('visible', $dish->visible) == false ? 'checked' : '' }} required
                                    >
                                </div>
